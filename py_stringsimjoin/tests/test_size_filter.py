...
class FilterPairTestCases(unittest.TestCase):
    def setUp(self):
        ...
        self.size_filter = SizeFilter(self.tokenizer,
                                      sim_measure_type='JACCARD',
                                      threshold=0.8)

    def test_to_be_pruned_pair(self):
        self.assertTrue(self.size_filter.filter_pair('aa bb cc dd ee', 'xx yy'))

    def test_to_be_passed_pair(self):
        self.assertFalse(self.size_filter.filter_pair('aa bb cc dd ee',
                                                      'xx yy aa tt'))
