...
class FilterPairTestCases(unittest.TestCase):
    ...
    def test_pos_filter_pass_missing_left(self):
...
class FilterTablesTestCases(unittest.TestCase):
    ...
    def test_jac_qg2_with_filter_attr_of_type_int(self):
        ...
        expected_pairs = set(['1,2', '2,1', '2,4', '5,3'])
...
class PositionFilterInvalidTestCases(unittest.TestCase):
    ...
    def test_invalid_ltable(self):
        position_filter = PositionFilter(self.tokenizer, self.sim_measure_type,
                                         self.threshold)
        position_filter.filter_tables([], self.B, 'A.id', 'B.id',
                                      'A.attr', 'B.attr')
    ...
    def test_invalid_l_key_attr(self):
        position_filter = PositionFilter(self.tokenizer, self.sim_measure_type,
                                         self.threshold)
        position_filter.filter_tables(self.A, self.B, 'A.invalid_id', 'B.id',
                                      'A.attr', 'B.attr')
    ...
    def test_invalid_r_key_attr(self):
        position_filter = PositionFilter(self.tokenizer, self.sim_measure_type,
                                         self.threshold)
        position_filter.filter_tables(self.A, self.B, 'A.id', 'B.invalid_id',
                                      'A.attr', 'B.attr')
