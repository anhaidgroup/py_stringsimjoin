...
def jaccard_join(ltable, rtable,
    ...
    if __use_cython__:
        from py_stringsimjoin.join.jaccard_join_cy import jaccard_join_cy
        return jaccard_join_cy(ltable, rtable,                                  
                               l_key_attr, r_key_attr,                          
                               l_join_attr, r_join_attr,                        
                               tokenizer, threshold, comp_op,                   
        ...
        from py_stringsimjoin.join.jaccard_join_py import jaccard_join_py       
        return jaccard_join_py(ltable, rtable,                                                
                               l_key_attr, r_key_attr,                                        
                               l_join_attr, r_join_attr,                                      
                               tokenizer, threshold, comp_op,                            
                               allow_empty, allow_missing,                         
