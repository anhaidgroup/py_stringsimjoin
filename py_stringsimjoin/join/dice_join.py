...
from py_stringsimjoin.utils.generic_helper import convert_dataframe_to_array, \
    ...
    split_table, get_temp_filenames, add_id_to_file, remove_files, merge_outputs_and_add_id
...
def dice_join(ltable, rtable,
    ...
    if file_name == None:
        ...
        output = _dice_join_in_mem(ltable, rtable, ltable_array, rtable_array, l_proj_attrs, r_proj_attrs,
                                     l_key_attr, r_key_attr,
                                     l_join_attr, r_join_attr,
                                     tokenizer, threshold, comp_op,
        ...
        output = _dice_join_ooc_mem(ltable, rtable, ltable_array, rtable_array, l_proj_attrs, r_proj_attrs,
                                      l_key_attr, r_key_attr,
                                      l_join_attr, r_join_attr,
                                      tokenizer, threshold, comp_op,
                                      allow_empty, allow_missing,
...
def _dice_join_ooc_mem(ltable, rtable,
...
def _dice_join_in_mem(ltable, rtable,
                        ltable_array, rtable_array,
                        l_columns, r_columns,
                        l_key_attr, r_key_attr,
                        l_join_attr, r_join_attr,
